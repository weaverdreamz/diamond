const Products = [
...

    {
        ...
        items:[  {
            ...
            price:2500,
            description:'The Aquanaut 5167/1A-001 is a subtle and understated watch and one of very few in the range to be available on a steel bracelet. The watch has a low profile on the wrist which makes it comfortable to wear and a sapphire crystal case back allows you to see the stunning calibre 324 S C self-winding movement. The dial is clean and legible with large Arabic numerals and luminescent blocks combined with the large hands and sweep second hand against the black embossed background. The bracelet with an invisible folding clasp has polished outer links and brushed inner links and matches the case perfectly.',
            color:'silver',
            ref:'5167A'
        },
    ]
